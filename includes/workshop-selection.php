...
//					$workshopList = [1,2,3];
//					$workshopList = get_posts_by_title( $title, 'product');
...
//					if( $query->post_count <= 1 ) {
						...
						create_product_variation( $workshopID, $variation_data );			
...
//			Test( '---' );
	...
	//		Test( $testP->get_attributes() );
	//		Test( $testP->get_children() );
		}
